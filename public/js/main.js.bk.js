...
// J - black wire, 74 #9, French Broom
// C - red wire, 67 #2, Cape Ivy
// L - green wire, 76 #11, Fennel
		...
		d3.csv("../data/ice8.csv",
	      ...
	      .on("click",function(){
			...
			handle = slider .append("g")
				...
				.attr("transform","translate(0," + timescale(dates[0]) + ",0)"); //maybe this
					  ...
					  d3.select("#show-voronoi")
						...
						function mouseout(d) {
							...
							update = function(data,gate) {
										...
										socket.emit('message', { observations, doctitle } );
										
										// socket.emit('message', document.title);
										...
										// 	.duration(250)
											...
											circles.exit().remove();
												...
												narr
															...
															.style("color", "#ffffff")
															.attr("class", function(d){if (d.pull != ''){return 'pull';} else{return "norm";}});
